...
#     messages: List[Dict[str, Any]] = []  # All Q&A pairs in this conversation
#     document_ids: List[str] = []  # Documents used in this conversation
#     is_active: bool = True
#     message_count: int = 0
...
#     preview_message: Optional[str] = None  # Last message for preview
...
#     model_used: str = settings.GROQ_MODEL
#     timestamp: datetime = Field(default_factory=lambda: datetime.now(timezone.utc))

# # Keep your existing QAHistory models for backward compatibility
