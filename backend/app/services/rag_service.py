...
#         # Build context without version info in the text
#         context_text = ""
#         all_dates = []
#         sources_metadata = []  # Store metadata separately
...
#             # Add context WITHOUT version info embedded in text
#             context_text += f"""
# [Document: {c['filename']}]
# {text}
...
#         # Build metadata summary for end of response
#         unique_sources = {}
#         for meta in sources_metadata:
#             filename = meta['filename']
#             if filename not in unique_sources or meta['version'] > unique_sources[filename]['version']:
#                 unique_sources[filename] = meta
        
#         sources_info = "\n".join([
#             f"- {meta['filename']} (Version {meta['version']}, Modified: {meta['modified']})"
...
# 5. After your answer, add a "Sources:" section listing the documents used
...
#             model=self.model_name,
#             messages=[
#                 {"role": "system", "content": "You are a precise policy assistant. Answer questions directly using only the provided context. Keep version information for the Sources section at the end."},
...
# Updated rag_service.py with create_vector_store_from_pages method
