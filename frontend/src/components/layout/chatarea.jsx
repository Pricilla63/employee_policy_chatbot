...
// const ChatArea = ({ selectedHistory, onNewMessage, onMessagesUpdate, currentMessages }) => {
//   const { user } = useAuth();
//   const [messages, setMessages] = useState([]);
//   const [input, setInput] = useState('');
//   const [loading, setLoading] = useState(false);
...
//     }
//   }, [selectedHistory]); // Remove currentMessages from dependencies
...
//   useEffect(() => {
//     if (selectedHistory) {
//       // If it's a conversation from sidebar, fetch the full conversation with messages
//       if (selectedHistory.messages && selectedHistory.messages.length > 0) {
//         // If messages are already in the conversation object, use them
//         setMessages(selectedHistory.messages);
//         if (onConversationIdChange) {
//           onConversationIdChange(selectedHistory._id);
//         }
//       } else {
//         // Otherwise, fetch the full conversation details
//         loadConversationMessages(selectedHistory._id);
//       }
//     } else {
...
//     try {
//       // If this is a brand new chat (no conversation ID and no selected history), create one
//       let conversationId = currentConversationId;
//       if (!conversationId && !selectedHistory) {
//         try {
//           // Create new conversation with the first question
//           await conversationsAPI.startNewConversation();
//           // Note: The actual conversation will be created by the backend when the first message is processed
//         } catch (error) {
...
//       if (selectedHistory.messages && Array.isArray(selectedHistory.messages)) {
